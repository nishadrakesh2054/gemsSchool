        ...
        <Row>
          <Accordion defaultActiveKey="0" className="accordion-general mt-5">
              ...
              <Accordion.Body className="main-ansa">
                <p>
                  * For the Primary and Secondary level it begins in the month
                  of April as per the date indicated in the notice. <br />* For
                  A-Levels the classes begin from the month of June. <br />* For
                  the NEB program the session begins in the month of July.
                </p>
              </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="1">
              ...
              <Accordion.Body className="main-ansa">
                * For Primary and High School [NEB & A Levels] timings are from
                07:30 am to 02:30 pm. <br />* For the students of classes 6 to
                10, the timings are 09:00 am to 04:10 pm.
              </Accordion.Body>
            </Accordion.Item>
            ...
            <Accordion.Item eventKey="3">
              ...
              <Accordion.Body className="main-ansa">
                Yes, prospective parents are welcome to visit the school, after
                making an appointment with the Admission manager.
              </Accordion.Body>
            </Accordion.Item>
